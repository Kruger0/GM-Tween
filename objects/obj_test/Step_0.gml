...
//    tween = new Tween(id).SetEase(TWEEN_EASE_BACK, TWEEN_CHANNEL_IN_OUT);
    
//    // Donnut
//    var _duration = 1.0;
//    tween.SetParallel(true);
//    tween.Variable(id, "x", mouse_x, _duration);
//    tween.Variable(id, "y", mouse_y, _duration);
//    tween.Variable(id, "image_xscale", 1, _duration).From(1.2);
//    tween.Variable(id, "image_yscale", 1, _duration).From(0.8);
